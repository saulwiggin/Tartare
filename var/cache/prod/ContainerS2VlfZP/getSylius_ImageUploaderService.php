...
return $this->services['sylius.image_uploader'] = new \Sylius\Component\Core\Uploader\ImageUploader(($this->services['knp_gaufrette.filesystem_map'] ?? $this->load('getKnpGaufrette_FilesystemMapService.php'))->get('sylius_image'), ($this->services['Sylius\\Component\\Core\\Generator\\ImagePathGeneratorInterface'] ?? ($this->services['Sylius\\Component\\Core\\Generator\\ImagePathGeneratorInterface'] = new \Sylius\Component\Core\Generator\UploadedImagePathGenerator())));
