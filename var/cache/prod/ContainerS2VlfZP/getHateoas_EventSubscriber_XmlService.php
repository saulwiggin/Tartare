...
include_once \dirname(__DIR__, 4).'/vendor/willdurand/hateoas/src/Hateoas/Serializer/EventSubscriber/XmlEventSubscriber.php';
include_once \dirname(__DIR__, 4).'/vendor/willdurand/hateoas/src/Hateoas/Serializer/XmlSerializerInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/willdurand/hateoas/src/Hateoas/Serializer/JMSSerializerMetadataAwareInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/willdurand/hateoas/src/Hateoas/Serializer/XmlSerializer.php';
