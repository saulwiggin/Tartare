...
return $this->services['sonata.block.renderer.default'] = new \Sonata\BlockBundle\Block\BlockRenderer(($this->services['sonata.block.manager'] ?? $this->load('getSonata_Block_ManagerService.php')), $a, ($this->privates['monolog.logger'] ?? $this->load('getMonolog_LoggerService.php')));
