...
return new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader(($this->privates['file_locator'] ?? $this->load('getFileLocatorService.php')), ($this->privates['fos_rest.routing.loader.processor'] ?? $this->load('getFosRest_Routing_Loader_ProcessorService.php')), true, ['json' => false, 'xml' => false, 'html' => true], NULL);
