...
class __TwigTemplate_63af6543dd01077623ce72475106340939816c39d43668b2917b39e5130224a8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"ui segment\">
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["configuration"] ?? null), "vars", [], "any", false, true, false, 11), "templates", [], "any", false, true, false, 11), "form", [], "any", true, true, false, 11)) {
            // line 12
            echo "        ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["configuration"] ?? null), "vars", [], "any", false, false, false, 12), "templates", [], "any", false, false, false, 12), "form", [], "any", false, false, false, 12), "@SyliusAdmin/Crud/Update/_content.html.twig", 12)->display($context);
            // line 13
            echo "    ";
        } else {
            // line 14
    ...
    ";
        // line 19
        $this->loadTemplate("@SyliusUi/Form/Buttons/_update.html.twig", "@SyliusAdmin/Crud/Update/_content.html.twig", 19)->display(twig_array_merge($context, ["paths" => ["cancel" => ($context["index_url"] ?? null)]]));
        // line 20
        echo "
    ";
        // line 21
...
";
    ...
    {
        return new Source("", "@SyliusAdmin/Crud/Update/_content.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Crud/Update/_content.html.twig");
    }
}
