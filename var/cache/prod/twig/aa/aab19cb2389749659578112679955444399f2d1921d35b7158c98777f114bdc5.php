...
class __TwigTemplate_98e4e635bef90c2681ecfcaff0b85f3ed5c8a269aaeaee8cc64bf6f2a5c02528 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"thirteen wide column\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 23
            echo "                ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, $context["item"], "attribute", [0 => "template"], "method", false, false, false, 23), "@SyliusAdmin/ProductVariant/_menu.html.twig", 23)->display(twig_array_merge($context, ["form" => ($context["form"] ?? null), "product_variant" => twig_get_attribute($this->env, $this->source, ($context["options"] ?? null), "product_variant", [], "any", false, false, false, 23)]));
            // line 24
            echo "            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return new Source("", "@SyliusAdmin/ProductVariant/_menu.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/ProductVariant/_menu.html.twig");
    }
}
