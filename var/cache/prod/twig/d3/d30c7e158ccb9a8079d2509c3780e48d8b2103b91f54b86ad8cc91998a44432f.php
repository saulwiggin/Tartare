...
class __TwigTemplate_5631c600dd9d0a7912508258010d68b55b91574d17fe9303f3eed7e6dce5fc9b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 1
        return $this->loadTemplate(((($context["layout"] ?? null)) ? (($context["layout"] ?? null)) : ("@SyliusPayum/layout.html.twig")), "SyliusPayumBundle:Action/Stripe:obtainCheckoutToken.html.twig", 1);
    }
...
";
    ...
    {
        return new Source("", "SyliusPayumBundle:Action/Stripe:obtainCheckoutToken.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/PayumBundle/Resources/views/Action/Stripe/obtainCheckoutToken.html.twig");
    }
}
