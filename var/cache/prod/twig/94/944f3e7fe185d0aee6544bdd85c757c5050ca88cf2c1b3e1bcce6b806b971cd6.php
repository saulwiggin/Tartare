...
class __TwigTemplate_d60d162ae600ba968915bb616ae30f701d4e477ec6654d5ff5b9a2144d92cfa8 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <td>
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["variant"] ?? null), "hasImages", [], "any", false, false, false, 11)) {
            // line 12
            echo "                        ";
            $this->loadTemplate("@SyliusAdmin/Product/_mainImage.html.twig", "@SyliusAdmin/Product/Show/_variantItem.html.twig", 12)->display(twig_array_merge($context, ["product" => ($context["variant"] ?? null), "filter" => "sylius_admin_product_large_thumbnail"]));
            // line 13
            echo "                    ";
        } else {
            // line 14
            echo "                        ";
            $this->loadTemplate("@SyliusAdmin/Product/_mainImage.html.twig", "@SyliusAdmin/Product/Show/_variantItem.html.twig", 14)->display(twig_array_merge($context, ["product" => ($context["product"] ?? null), "filter" => "sylius_admin_product_large_thumbnail"]));
            // line 15
            echo "                    ";
        }
        // line 16
...
";
    ...
    {
        return new Source("", "@SyliusAdmin/Product/Show/_variantItem.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Product/Show/_variantItem.html.twig");
    }
}
