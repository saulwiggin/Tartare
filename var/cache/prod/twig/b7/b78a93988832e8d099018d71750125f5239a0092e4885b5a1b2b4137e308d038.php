...
class __TwigTemplate_72d8f0ab31b1836fb45c52d459564d8c3fe6d997b67d3c20f8ccf7a20064af9b extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["locale"] => $context["translationForm"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                    ...
                    if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["field"], "vars", [], "any", false, false, false, 33), "name", [], "any", false, false, false, 33) != "slug")) {
                        ...
                        // line 36
                        echo "                            ";
                        $this->loadTemplate(($context["slugFieldTemplate"] ?? null), "@SyliusAdmin/Macro/translationForm.html.twig", 36)->display(twig_array_merge($context, ["slugField" => twig_get_attribute($this->env, $this->source, $context["translationForm"], "slug", [], "any", false, false, false, 36), "resource" => ($context["resource"] ?? null)]));
                        // line 37
                        echo "                        ";
                    }
                    // line 38
...
";
    ...
    {
        return new Source("", "@SyliusAdmin/Macro/translationForm.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Macro/translationForm.html.twig");
    }
}
