...
class __TwigTemplate_30688a6fdf0c4a05e264f25ad8390534fbe7930ead74b8c84887e999ad718559 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"content\">
        ...
        echo "
                ...
                <div class=\"item\">
                    ";
        // line 14
        $this->loadTemplate([0 => ((("@SyliusShop/Account/Order/Label/State" . "/") . twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "state", [], "any", false, false, false, 14)) . ".html.twig"), 1 => "@SyliusUi/Label/_default.html.twig"], "@SyliusShop/Account/Order/Show/_header.html.twig", 14)->display(twig_array_merge($context, ["value" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(("sylius.ui." . twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "state", [], "any", false, false, false, 14)))]));
        // line 15
        echo "                </div>
                <div class=\"item\">
                    ";
...
";
    ...
    {
        return new Source("", "@SyliusShop/Account/Order/Show/_header.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Account/Order/Show/_header.html.twig");
    }
}
