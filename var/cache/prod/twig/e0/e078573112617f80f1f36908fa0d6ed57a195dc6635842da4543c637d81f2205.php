...
class __TwigTemplate_08ce2366681cfa49048d336925de90fce5b429ae63c2aa85afaf1da5774b432a extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ui small icon message\">
        ...
        <div class=\"content\">
            ...
            if ((($context["state"] ?? null) != "cart")) {
                ...
                ";
                // line 21
                $this->loadTemplate("@SyliusShop/Common/Order/Label/PaymentState/singlePaymentState.html.twig", "SyliusShopBundle:Common/Order:_payments.html.twig", 21)->display(twig_array_merge($context, ["state" => ($context["state"] ?? null)]));
                // line 22
                echo "            </p>
            ";
            }
...
";
    ...
    {
        return new Source("", "SyliusShopBundle:Common/Order:_payments.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Common/Order/_payments.html.twig");
    }
}
