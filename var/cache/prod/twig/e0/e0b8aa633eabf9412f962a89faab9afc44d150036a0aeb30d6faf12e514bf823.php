...
class __TwigTemplate_c38492d373dd583978cc2de1729ad406d19e55a4d004fce4b68f95963b87a2af extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((twig_length_filter($this->env, ($context["addresses"] ?? null)) > 0)) {
            ...
            if ( !(null === ($context["default_address"] ?? null))) {
                // line 25
                echo "            ";
                $this->loadTemplate("@SyliusShop/Account/AddressBook/_defaultAddress.html.twig", "@SyliusShop/Account/AddressBook/index.html.twig", 25)->display(twig_array_merge($context, ["address" => ($context["default_address"] ?? null)]));
                // line 26
                echo "        ";
            }
            // line 27
    ...
    {
        return new Source("", "@SyliusShop/Account/AddressBook/index.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Account/AddressBook/index.html.twig");
    }
}
