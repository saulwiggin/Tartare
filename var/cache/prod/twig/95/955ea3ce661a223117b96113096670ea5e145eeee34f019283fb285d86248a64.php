...
class __TwigTemplate_925d9a36121e8bbe2568abb8fce8b936c10453207cccaa548ca6b56ccd6c0780 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 6
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "version", [], "any", false, false, false, 6), "html", null, true);
        echo "</span>
    ";
        ...
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "version", [], "any", false, false, false, 12), "html", null, true);
        echo "</a></span>
            </div>
            <div class=\"sf-toolbar-info-piece\">
                <b>Extensions</b>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "extensions", [], "any", false, false, false, 16));
        ...
        <div class=\"sf-toolbar-info-group\">
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span class=\"sf-toolbar-status sf-toolbar-status-green\">
                    <abbr title=\"Current ";
        // line 27
        if ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "currencyCode", [], "any", false, false, false, 27) == twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "defaultCurrencyCode", [], "any", false, false, false, 27))) {
            echo "and default ";
        }
        echo "currency\">
                        ";
        ...
        echo "
                ...
                ";
        // line 31
        if ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "currencyCode", [], "any", false, false, false, 31) != twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "defaultCurrencyCode", [], "any", false, false, false, 31))) {
            // line 32
            echo "                    <span class=\"sf-toolbar-status\">
                        <abbr title=\"Default locale\">
                            ";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "defaultCurrencyCode", [], "any", false, false, false, 34), "html", null, true);
            echo "
                        </abbr>
                    </span>
                ";
        ...
        echo "            </div>
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span class=\"sf-toolbar-status sf-toolbar-status-green\">
                    <abbr title=\"Current ";
        // line 42
        if ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "localeCode", [], "any", false, false, false, 42) == twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "defaultLocaleCode", [], "any", false, false, false, 42))) {
            echo "and default ";
        }
        echo "locale\">
                        ";
        ...
        echo "
                ...
                ";
        // line 46
        if ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "localeCode", [], "any", false, false, false, 46) != twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "defaultLocaleCode", [], "any", false, false, false, 46))) {
            // line 47
            echo "                    <span class=\"sf-toolbar-status\">
                        <abbr title=\"Default locale\">
                            ";
            // line 49
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "defaultLocaleCode", [], "any", false, false, false, 49), "html", null, true);
            echo "
                        </abbr>
                    </span>
                ";
    ...
    {
        return array (  172 => 63,  169 => 62,  158 => 53,  151 => 49,  147 => 47,  145 => 46,  139 => 43,  133 => 42,  127 => 38,  120 => 34,  116 => 32,  114 => 31,  108 => 28,  102 => 27,  94 => 21,  85 => 18,  80 => 17,  76 => 16,  69 => 12,  64 => 9,  61 => 8,  56 => 6,  53 => 5,  50 => 4,  46 => 3,  35 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "SyliusCoreBundle:Collector:sylius.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/CoreBundle/Resources/views/Collector/sylius.html.twig");
    }
}
