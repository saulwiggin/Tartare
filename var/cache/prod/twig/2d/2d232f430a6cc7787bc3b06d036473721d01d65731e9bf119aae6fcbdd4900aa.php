...
class __TwigTemplate_ecd7700d937a9cc3ece39e9672daa67c6d0caed923dff5b51619c302202a63f5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"ui segment\">
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["configuration"] ?? null), "vars", [], "any", false, true, false, 10), "templates", [], "any", false, true, false, 10), "form", [], "any", true, true, false, 10)) {
            // line 11
            echo "        ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["configuration"] ?? null), "vars", [], "any", false, false, false, 11), "templates", [], "any", false, false, false, 11), "form", [], "any", false, false, false, 11), "@SyliusAdmin/Crud/Create/_content.html.twig", 11)->display($context);
            // line 12
            echo "    ";
        } else {
            // line 13
    ...
    ";
        // line 18
        $this->loadTemplate("@SyliusUi/Form/Buttons/_create.html.twig", "@SyliusAdmin/Crud/Create/_content.html.twig", 18)->display(twig_array_merge($context, ["paths" => ["cancel" => ($context["index_url"] ?? null)]]));
        // line 19
        echo "
    ";
        // line 20
...
";
    ...
    {
        return new Source("", "@SyliusAdmin/Crud/Create/_content.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Crud/Create/_content.html.twig");
    }
}
