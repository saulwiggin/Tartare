...
class __TwigTemplate_4d60418cfe0fa3e0065f602a666791de3155badc450236bcb73b5fde2babbbf8 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 12
        return $this->loadTemplate(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["sonata_block"] ?? null), "templates", [], "any", false, false, false, 12), "block_base", [], "any", false, false, false, 12), "SonataBlockBundle:Block:block_exception_debug.html.twig", 12);
    }
...
";
    ...
    {
        return new Source("", "SonataBlockBundle:Block:block_exception_debug.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sonata-project/block-bundle/src/Resources/views/Block/block_exception_debug.html.twig");
    }
}
