...
class __TwigTemplate_ec98d31f636bcb9db2335b61e9a0468dc458c654c76abaeb49483c9c091587aa extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <td>
        ";
        // line 7
        $this->loadTemplate("@SyliusShop/Product/_info.html.twig", "SyliusShopBundle:Common/Order/Table:_item.html.twig", 7)->display(twig_array_merge($context, ["variant" => twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "variant", [], "any", false, false, false, 7)]));
        // line 8
        echo "    </td>
    <td>
        ";
...
";
    ...
    {
        return new Source("", "SyliusShopBundle:Common/Order/Table:_item.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Common/Order/Table/_item.html.twig");
    }
}
