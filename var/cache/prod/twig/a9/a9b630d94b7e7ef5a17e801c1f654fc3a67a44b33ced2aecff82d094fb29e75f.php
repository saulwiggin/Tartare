...
class __TwigTemplate_aa260cd4c52b252fb240d1202002a7663984ff897f1d6be0be25997fe1c9ca57 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 33
        $this->loadTemplate("@SyliusShop/Cart/Summary/_update.html.twig", "@SyliusShop/Cart/Summary/_items.html.twig", 33)->display(twig_array_merge($context, ["main_form" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 33), "id", [], "any", false, false, false, 33)]));
        // line 34
        echo "</div>
";
    }
    ...
    {
        return new Source("", "@SyliusShop/Cart/Summary/_items.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Cart/Summary/_items.html.twig");
    }
}
