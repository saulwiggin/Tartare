...
class __TwigTemplate_81b0b391851adab686e3d2ea2e5a284b5809f6a24b5c0350adbe6542a8b20a90 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ui attached segment\" id=\"billing-address\">
        ";
            // line 6
            $this->loadTemplate("@SyliusAdmin/Common/_address.html.twig", "SyliusAdminBundle:Order/Show:_addresses.html.twig", 6)->display(twig_array_merge($context, ["address" => twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "billingAddress", [], "any", false, false, false, 6)]));
            // line 7
            echo "    </div>
";
        }
    ...
    <div class=\"ui attached segment\" id=\"shipping-address\">
        ";
            // line 14
            $this->loadTemplate("@SyliusAdmin/Common/_address.html.twig", "SyliusAdminBundle:Order/Show:_addresses.html.twig", 14)->display(twig_array_merge($context, ["address" => twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "shippingAddress", [], "any", false, false, false, 14)]));
            // line 15
            echo "    </div>
";
        }
...
";
    ...
    {
        return new Source("", "SyliusAdminBundle:Order/Show:_addresses.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/_addresses.html.twig");
    }
}
