...
class __TwigTemplate_7496f5d20e466b61cb78eaf0bf0fd37826941ef29523bb0966f6ceeb25ec642a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 3
        $this->loadTemplate("@SyliusShop/Product/_horizontalList.html.twig", "@SyliusShop/Product/Show/_association.html.twig", 3)->display(twig_array_merge($context, ["products" => twig_get_attribute($this->env, $this->source, ($context["product_association"] ?? null), "associatedProducts", [], "any", false, false, false, 3)]));
        // line 4
        echo "</div>
";
    }
    ...
    {
        return new Source("", "@SyliusShop/Product/Show/_association.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Product/Show/_association.html.twig");
    }
}
