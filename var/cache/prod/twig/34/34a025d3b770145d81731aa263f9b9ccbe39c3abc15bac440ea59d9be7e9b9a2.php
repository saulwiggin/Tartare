...
class __TwigTemplate_f78457816e224df26764e892c1777e3e251eb405242d8e8aace9ceeca4fc30ed extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ui segment address\">
        ...
        echo ">
            <div class=\"column\">
                ";
        // line 7
        $this->loadTemplate("@SyliusShop/Common/_address.html.twig", "@SyliusShop/Account/AddressBook/_item.html.twig", 7)->display(twig_array_merge($context, ["address" => ($context["address"] ?? null)]));
        // line 8
        echo "            </div>
...
";
    ...
    {
        return new Source("", "@SyliusShop/Account/AddressBook/_item.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Account/AddressBook/_item.html.twig");
    }
}
