...
class __TwigTemplate_19a11b9a0bfbf9ca5052b6d839506046e29c4b30a2429a0e8ba7a31afe106f7b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"thirteen wide column\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 23
            echo "                ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, $context["item"], "attribute", [0 => "template"], "method", false, false, false, 23), "SyliusAdminBundle:Product:_menu.html.twig", 23)->display(twig_array_merge($context, ["form" => ($context["form"] ?? null), "product" => twig_get_attribute($this->env, $this->source, ($context["options"] ?? null), "product", [], "any", false, false, false, 23)]));
            // line 24
            echo "            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return new Source("", "SyliusAdminBundle:Product:_menu.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Product/_menu.html.twig");
    }
}
