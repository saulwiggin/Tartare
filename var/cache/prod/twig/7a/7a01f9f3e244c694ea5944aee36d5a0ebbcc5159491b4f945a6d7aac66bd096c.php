...
class __TwigTemplate_9de4e2c779c7bd374c320e1e1ca223b4817c4b30b2454dc3df1d55745999598c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"content\">
        ...
        echo "
                ...
                <div class=\"item\" id=\"sylius-order-state\">
                    ";
        // line 13
        $this->loadTemplate([0 => ((("@SyliusAdmin/Order/Label/State" . "/") . twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "state", [], "any", false, false, false, 13)) . ".html.twig"), 1 => "@SyliusUi/Label/_default.html.twig"], "@SyliusAdmin/Order/Show/_header.html.twig", 13)->display(twig_array_merge($context, ["value" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(("sylius.ui." . twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "state", [], "any", false, false, false, 13)))]));
        // line 14
        echo "                </div>
        ...
        echo "
                    ";
        // line 23
        $this->loadTemplate("@SyliusAdmin/Common/_channel.html.twig", "@SyliusAdmin/Order/Show/_header.html.twig", 23)->display(twig_array_merge($context, ["channel" => twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "channel", [], "any", false, false, false, 23)]));
        // line 24
        echo "                </div>
            </div>
        </div>
...
";
    ...
    {
        return new Source("", "@SyliusAdmin/Order/Show/_header.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/_header.html.twig");
    }
}
