...
class __TwigTemplate_b026b7b26a264f57a4d1f8aa3c6fde326721b567e832d9e30bed6c31b4a6239a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"ui header\">
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["variant"] ?? null), "hasImages", [], "any", false, false, false, 4)) {
            // line 5
            echo "        ";
            $this->loadTemplate("@SyliusShop/Product/_mainImage.html.twig", "@SyliusShop/Product/_info.html.twig", 5)->display(twig_array_merge($context, ["product" => ($context["variant"] ?? null), "filter" => "sylius_shop_product_tiny_thumbnail"]));
            // line 6
            echo "    ";
        } else {
            // line 7
            echo "        ";
            $this->loadTemplate("@SyliusShop/Product/_mainImage.html.twig", "@SyliusShop/Product/_info.html.twig", 7)->display(twig_array_merge($context, ["product" => ($context["product"] ?? null), "filter" => "sylius_shop_product_tiny_thumbnail"]));
            // line 8
            echo "    ";
        }
        // line 9
...
";
    ...
    {
        return new Source("", "@SyliusShop/Product/_info.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Product/_info.html.twig");
    }
}
