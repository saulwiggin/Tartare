...
class __TwigTemplate_4ed130df30f37eb772a9ae7b7dcc6675c5fe9ef80b6ae69f522317a9610752f9 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 11
        return $this->loadTemplate(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["sonata_block"] ?? null), "templates", [], "any", false, false, false, 11), "block_base", [], "any", false, false, false, 11), "@SonataBlock/Block/block_core_rss.html.twig", 11);
    }
...
";
    ...
    {
        return new Source("", "@SonataBlock/Block/block_core_rss.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sonata-project/block-bundle/src/Resources/views/Block/block_core_rss.html.twig");
    }
}
