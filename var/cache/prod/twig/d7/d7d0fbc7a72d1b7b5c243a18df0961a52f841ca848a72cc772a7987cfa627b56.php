...
class __TwigTemplate_b9fc1285f60ac2c7d1f2cc2cd1290525952d3bb6331d8d0e6c7cff39c5d34b9f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["options"] ?? null), "vars", [], "any", false, true, false, 3), "labels", [], "any", true, true, false, 3)) {
            ...
            // line 6
            echo "    ";
            $this->loadTemplate("@SyliusUi/Label/_default.html.twig", "SyliusUiBundle:Grid/Field:state.html.twig", 6)->display(twig_array_merge($context, ["value" => ($context["value"] ?? null)]));
        }
    }
    ...
    {
        return new Source("", "SyliusUiBundle:Grid/Field:state.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Grid/Field/state.html.twig");
    }
}
