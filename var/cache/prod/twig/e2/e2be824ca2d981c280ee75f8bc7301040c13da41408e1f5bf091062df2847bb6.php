...
class __TwigTemplate_a3cabae67c0aba33eb7846aca7fdba5860bebdfa126a95e12ef323c77f1b1c72 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 2
        $this->loadTemplate((("@SyliusAdmin/Order/Label/ShippingState/" . twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "shippingState", [], "any", false, false, false, 2)) . ".html.twig"), "SyliusAdminBundle:Order/Show:_shipments.html.twig", 2)->display(twig_array_merge($context, ["value" => ("sylius.ui." . twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "shippingState", [], "any", false, false, false, 2)), "attached" => true]));
        // line 3
        echo "    ";
...
";
    ...
    {
        return new Source("", "SyliusAdminBundle:Order/Show:_shipments.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/_shipments.html.twig");
    }
}
