...
class __TwigTemplate_8fdf7ce920069363b2b2728d31e6f6eff5b255cd94b6d639ec072923c1543873 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
            // line 3
            $this->loadTemplate((("@SyliusAdmin/Order/Label/PaymentState/" . twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "paymentState", [], "any", false, false, false, 3)) . ".html.twig"), "@SyliusAdmin/Order/Show/_payments.html.twig", 3)->display(twig_array_merge($context, ["value" => ("sylius.ui." . twig_get_attribute($this->env, $this->source, ($context["order"] ?? null), "paymentState", [], "any", false, false, false, 3)), "attached" => true]));
            // line 4
...
";
    ...
    {
        return new Source("", "@SyliusAdmin/Order/Show/_payments.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/_payments.html.twig");
    }
}
