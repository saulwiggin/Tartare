...
class __TwigTemplate_ef231ff132cae4956b2770773d2a9a06d9d0b90f4773cf7eea0d1f2fdcabe8de extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 12
        return $this->loadTemplate(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["sonata_block"] ?? null), "templates", [], "any", false, false, false, 12), "block_base", [], "any", false, false, false, 12), "@SonataBlock/Block/block_container.html.twig", 12);
    }
    ...
    {
        return new Source("", "@SonataBlock/Block/block_container.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sonata-project/block-bundle/src/Resources/views/Block/block_container.html.twig");
    }
}
