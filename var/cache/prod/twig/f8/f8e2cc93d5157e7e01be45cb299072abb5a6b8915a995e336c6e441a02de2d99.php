...
class __TwigTemplate_cd8b75f832469b44d162e937ff9fb0986406d7f2a9d14ed2789b765ccabffed2 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"thirteen wide column\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 23
            echo "                ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, $context["item"], "attribute", [0 => "template"], "method", false, false, false, 23), "@SyliusAdmin/Product/_menu.html.twig", 23)->display(twig_array_merge($context, ["form" => ($context["form"] ?? null), "product" => twig_get_attribute($this->env, $this->source, ($context["options"] ?? null), "product", [], "any", false, false, false, 23)]));
            // line 24
            echo "            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return new Source("", "@SyliusAdmin/Product/_menu.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Product/_menu.html.twig");
    }
}
