 ...
 */
class Shipment extends \App\Entity\Shipping\Shipment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'order', 'id', 'state', 'method', 'units', 'tracking', 'shippedAt', 'createdAt', 'updatedAt'];
        }
