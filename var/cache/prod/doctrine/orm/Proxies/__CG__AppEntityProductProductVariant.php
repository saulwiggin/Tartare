...
class ProductVariant extends \App\Entity\Product\ProductVariant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'version', 'onHold', 'onHand', 'tracked', 'weight', 'width', 'height', 'depth', 'taxCategory', 'shippingCategory', 'channelPricings', 'shippingRequired', 'images', 'id', 'code', 'product', 'optionValues', 'position', 'createdAt', 'updatedAt', 'translations', 'translationsCache', 'currentLocale', 'currentTranslation', 'fallbackLocale'];
        }
     ...
     * {@inheritDoc}
     */
    public function setShippingCategory(?\Sylius\Component\Shipping\Model\ShippingCategoryInterface $category): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShippingCategory', [$category]);

        parent::setShippingCategory($category);
    }
