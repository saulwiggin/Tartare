...
class __TwigTemplate_2aa32863e509e466cf4948e1845ba3ffa8674fb21f6393da99361da4d9b673b9 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        <div class=\"content\">
            ...
            if (((isset($context["state"]) || array_key_exists("state", $context) ? $context["state"] : (function () { throw new RuntimeError('Variable "state" does not exist.', 13, $this->source); })()) != "cart")) {
                ...
                ";
                // line 15
                $this->loadTemplate("@SyliusShop/Common/Order/Label/ShipmentState/singleShipmentState.html.twig", "SyliusShopBundle:Common/Order:_shipments.html.twig", 15)->display(twig_array_merge($context, ["state" => (isset($context["state"]) || array_key_exists("state", $context) ? $context["state"] : (function () { throw new RuntimeError('Variable "state" does not exist.', 15, $this->source); })())]));
                // line 16
                echo "            </p>
            ";
            }
...
{% endfor %}
", "SyliusShopBundle:Common/Order:_shipments.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Common/Order/_shipments.html.twig");
    }
}
