...
class __TwigTemplate_5125fc33073d7e1c3c4b534b277187aa0eb47b364c6a4d6ded3dc9ff0a12f4ba extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"ui segment\">
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["configuration"] ?? null), "vars", [], "any", false, true, false, 10), "templates", [], "any", false, true, false, 10), "form", [], "any", true, true, false, 10)) {
            // line 11
            echo "        ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["configuration"]) || array_key_exists("configuration", $context) ? $context["configuration"] : (function () { throw new RuntimeError('Variable "configuration" does not exist.', 11, $this->source); })()), "vars", [], "any", false, false, false, 11), "templates", [], "any", false, false, false, 11), "form", [], "any", false, false, false, 11), "SyliusAdminBundle:Crud/Create:_content.html.twig", 11)->display($context);
            // line 12
            echo "    ";
        } else {
            // line 13
    ...
    ";
        // line 16
        echo $this->extensions['Sylius\Bundle\UiBundle\Twig\TemplateEventExtension']->render([0 => ((isset($context["event_prefix"]) || array_key_exists("event_prefix", $context) ? $context["event_prefix"] : (function () { throw new RuntimeError('Variable "event_prefix" does not exist.', 16, $this->source); })()) . ".form"), 1 => "sylius.admin.create.form"], ["metadata" => (isset($context["metadata"]) || array_key_exists("metadata", $context) ? $context["metadata"] : (function () { throw new RuntimeError('Variable "metadata" does not exist.', 16, $this->source); })()), "resource" => (isset($context["resource"]) || array_key_exists("resource", $context) ? $context["resource"] : (function () { throw new RuntimeError('Variable "resource" does not exist.', 16, $this->source); })()), "form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })())]);
        echo "

    ";
        // line 18
        $this->loadTemplate("@SyliusUi/Form/Buttons/_create.html.twig", "SyliusAdminBundle:Crud/Create:_content.html.twig", 18)->display(twig_array_merge($context, ["paths" => ["cancel" => (isset($context["index_url"]) || array_key_exists("index_url", $context) ? $context["index_url"] : (function () { throw new RuntimeError('Variable "index_url" does not exist.', 18, $this->source); })())]]));
        // line 19
        echo "
    ";
        // line 20
...
";
    ...
    {
        return array (  89 => 21,  85 => 20,  82 => 19,  80 => 18,  75 => 16,  72 => 15,  66 => 13,  63 => 12,  60 => 11,  57 => 10,  55 => 9,  51 => 8,  47 => 6,  45 => 3,  44 => 2,  43 => 1,);
    }
...
", "SyliusAdminBundle:Crud/Create:_content.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Crud/Create/_content.html.twig");
    }
}
