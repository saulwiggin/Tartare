...
class __TwigTemplate_513bfaf0a228091e3b2bc7edc3432f76775b88073105d961b446c8af64b55e48 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            // line 4
            if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["taxon"]) || array_key_exists("taxon", $context) ? $context["taxon"] : (function () { throw new RuntimeError('Variable "taxon" does not exist.', 4, $this->source); })()), "children", [], "any", false, false, false, 4)) > 0)) {
                // line 5
            ...
            <div class=\"menu\">
                ...
                // line 9
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["taxon"]) || array_key_exists("taxon", $context) ? $context["taxon"] : (function () { throw new RuntimeError('Variable "taxon" does not exist.', 9, $this->source); })()), "children", [], "any", false, false, false, 9));
...
{% endif %}
", "SyliusShopBundle:Taxon:_horizontalMenu.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Taxon/_horizontalMenu.html.twig");
    }
}
