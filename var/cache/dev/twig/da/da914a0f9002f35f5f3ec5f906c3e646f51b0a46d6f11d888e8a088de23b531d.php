...
class __TwigTemplate_8030e574bbc8546f6421573297c34951423334692ca9bddebb263f434205fbda extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<tr>
    ";
        // line 50
        $this->loadTemplate("@SyliusShop/Common/Order/Table/_shipping.html.twig", "SyliusShopBundle:Common/Order/Table:_totals.html.twig", 50)->display(twig_array_merge($context, ["order" => (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 50, $this->source); })())]));
        // line 51
        echo "</tr>
<tr>
...
{% endif %}
", "SyliusShopBundle:Common/Order/Table:_totals.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Common/Order/Table/_totals.html.twig");
    }
}
