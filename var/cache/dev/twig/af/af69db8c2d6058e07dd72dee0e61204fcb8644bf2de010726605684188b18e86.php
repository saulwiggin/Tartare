...
class __TwigTemplate_23e69d9d945df67bf9a8de9d26d5ee246a1b1c0e6065284286454d5463ec0eb2 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"content\">
        ...
        echo "
                ...
                <div class=\"item\" id=\"sylius-order-state\">
                    ";
        // line 13
        $this->loadTemplate([0 => ((("@SyliusAdmin/Order/Label/State" . "/") . twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 13, $this->source); })()), "state", [], "any", false, false, false, 13)) . ".html.twig"), 1 => "@SyliusUi/Label/_default.html.twig"], "SyliusAdminBundle:Order/Show:_header.html.twig", 13)->display(twig_array_merge($context, ["value" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(("sylius.ui." . twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 13, $this->source); })()), "state", [], "any", false, false, false, 13)))]));
        // line 14
        echo "                </div>
        ...
        echo "
                    ";
        // line 23
        $this->loadTemplate("@SyliusAdmin/Common/_channel.html.twig", "SyliusAdminBundle:Order/Show:_header.html.twig", 23)->display(twig_array_merge($context, ["channel" => twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 23, $this->source); })()), "channel", [], "any", false, false, false, 23)]));
        // line 24
        echo "                </div>
            </div>
        </div>
...
", "SyliusAdminBundle:Order/Show:_header.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/_header.html.twig");
    }
}
