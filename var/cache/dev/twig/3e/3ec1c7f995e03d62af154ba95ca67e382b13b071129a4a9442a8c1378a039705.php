...
class __TwigTemplate_e26d9f17916cdf32a89ee81f30ba592efbf8c5660a16b3014af02fc542fa99ee extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"field\">
        ...
        echo ">
            ";
        // line 4
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 4, $this->source); })()), 'widget', call_user_func_array($this->env->getFunction('sylius_test_form_attribute')->getCallable(), ["payment-method-select"]));
        echo "
        </div>
    </div>
    <div class=\"content\">
...
", "SyliusShopBundle:Checkout/SelectPayment:_choice.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/SelectPayment/_choice.html.twig");
    }
}
