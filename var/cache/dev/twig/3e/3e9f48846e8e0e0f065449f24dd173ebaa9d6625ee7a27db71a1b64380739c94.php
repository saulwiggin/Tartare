...
class __TwigTemplate_adb1678d73a9faf8de38d4288012e3e8dd217f82946b566413c8bbfdb1b8175e extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["locale"] => $context["translationForm"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                    ...
                    if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["field"], "vars", [], "any", false, false, false, 33), "name", [], "any", false, false, false, 33) != "slug")) {
                        ...
                        // line 36
                        echo "                            ";
                        $this->loadTemplate((isset($context["slugFieldTemplate"]) || array_key_exists("slugFieldTemplate", $context) ? $context["slugFieldTemplate"] : (function () { throw new RuntimeError('Variable "slugFieldTemplate" does not exist.', 36, $this->source); })()), "SyliusAdminBundle:Macro:translationForm.html.twig", 36)->display(twig_array_merge($context, ["slugField" => twig_get_attribute($this->env, $this->source, $context["translationForm"], "slug", [], "any", false, false, false, 36), "resource" => (isset($context["resource"]) || array_key_exists("resource", $context) ? $context["resource"] : (function () { throw new RuntimeError('Variable "resource" does not exist.', 36, $this->source); })())]));
                        // line 37
                        echo "                        ";
                    }
                    // line 38
...
{% endmacro %}
", "SyliusAdminBundle:Macro:translationForm.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Macro/translationForm.html.twig");
    }
}
