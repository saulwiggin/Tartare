...
class __TwigTemplate_dac16ba7c36442f09cc7848ea75896fc2f8ab2a1f95b681b746ce40182e9fa62 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_headers($__grid__ = null, $__definition__ = null, $__requestAttributes__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 2
            echo "    ";
            $macros["sorting"] = $this->loadTemplate("@SyliusUi/Macro/sorting.html.twig", "SyliusUiBundle:Macro:table.html.twig", 2)->unwrap();
            // line 3
            echo "
    ";
            // line 4
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                // line 30
                echo "        <td>";
                echo call_user_func_array($this->env->getFunction('sylius_grid_render_field')->getCallable(), [(isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 30, $this->source); })()), $context["field"], (isset($context["row"]) || array_key_exists("row", $context) ? $context["row"] : (function () { throw new RuntimeError('Variable "row" does not exist.', 30, $this->source); })())]);
                echo "</td>
    ";
            }
            $_parent = $context['_parent'];
            ...
            <div class=\"ui buttons\">
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
                    // line 36
                    echo "                    ";
                    echo call_user_func_array($this->env->getFunction('sylius_grid_render_action')->getCallable(), [(isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 36, $this->source); })()), $context["action"], (isset($context["row"]) || array_key_exists("row", $context) ? $context["row"] : (function () { throw new RuntimeError('Variable "row" does not exist.', 36, $this->source); })())]);
                    echo "
                ";
                }
                $_parent = $context['_parent'];
            ...
            <div class=\"ui buttons\">
                ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
                        // line 43
                        echo "                    ";
                        echo call_user_func_array($this->env->getFunction('sylius_grid_render_action')->getCallable(), [(isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 43, $this->source); })()), $context["action"], (isset($context["row"]) || array_key_exists("row", $context) ? $context["row"] : (function () { throw new RuntimeError('Variable "row" does not exist.', 43, $this->source); })())]);
                        echo "
                ";
                    }
                    $_parent = $context['_parent'];
...
{% endmacro %}
", "SyliusUiBundle:Macro:table.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Macro/table.html.twig");
    }
}
