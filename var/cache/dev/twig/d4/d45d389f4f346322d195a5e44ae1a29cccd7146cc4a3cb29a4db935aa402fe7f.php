...
class __TwigTemplate_dbe813eb2318607b31cfc0cde4ddd7bfcff49396a1a823a137fbdc7d3df3adaa extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block icon %}
    ...
    {% if icon %}<i class=\"icon {{ icon }}\"></i> {% endif %}
{% endblock %}
", "@SyliusUi/Menu/top.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Menu/top.html.twig");
    }
}
