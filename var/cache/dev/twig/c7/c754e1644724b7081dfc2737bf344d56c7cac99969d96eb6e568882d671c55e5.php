...
class __TwigTemplate_fd115a4f7bac3a94a188effafeec463d34b0f42de3bbd400a7641b514be13a95 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 33
        $this->loadTemplate("@SyliusShop/Cart/Summary/_update.html.twig", "SyliusShopBundle:Cart/Summary:_items.html.twig", 33)->display(twig_array_merge($context, ["main_form" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 33, $this->source); })()), "vars", [], "any", false, false, false, 33), "id", [], "any", false, false, false, 33)]));
        // line 34
        echo "</div>
";
...
", "SyliusShopBundle:Cart/Summary:_items.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Cart/Summary/_items.html.twig");
    }
}
