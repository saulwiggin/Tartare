...
class __TwigTemplate_815ccd77c336f5d5ac9c05573ff033c8b086154be53ef1e5620f6ec519080d70 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"item\" ";
    ...
    <div class=\"field\">
        ...
        echo ">
            ";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), 'widget', call_user_func_array($this->env->getFunction('sylius_test_form_attribute')->getCallable(), ["shipping-method-select"]));
        echo "
        </div>
    </div>
    <div class=\"content\">
...
", "SyliusShopBundle:Checkout/SelectShipping:_choice.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/SelectShipping/_choice.html.twig");
    }
}
