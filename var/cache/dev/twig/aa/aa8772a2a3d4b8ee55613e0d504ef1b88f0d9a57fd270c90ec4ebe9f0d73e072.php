...
class __TwigTemplate_bae046af3b1378562cab6cfb492fd0ab074257755fb9c549c54735885a6f8c06 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"ui header\">
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["variant"]) || array_key_exists("variant", $context) ? $context["variant"] : (function () { throw new RuntimeError('Variable "variant" does not exist.', 4, $this->source); })()), "hasImages", [], "any", false, false, false, 4)) {
            // line 5
            echo "        ";
            $this->loadTemplate("@SyliusShop/Product/_mainImage.html.twig", "SyliusShopBundle:Product:_info.html.twig", 5)->display(twig_array_merge($context, ["product" => (isset($context["variant"]) || array_key_exists("variant", $context) ? $context["variant"] : (function () { throw new RuntimeError('Variable "variant" does not exist.', 5, $this->source); })()), "filter" => "sylius_shop_product_tiny_thumbnail"]));
            // line 6
            echo "    ";
        } else {
            // line 7
            echo "        ";
            $this->loadTemplate("@SyliusShop/Product/_mainImage.html.twig", "SyliusShopBundle:Product:_info.html.twig", 7)->display(twig_array_merge($context, ["product" => (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 7, $this->source); })()), "filter" => "sylius_shop_product_tiny_thumbnail"]));
            // line 8
            echo "    ";
        }
        // line 9
...
{% endif %}
", "SyliusShopBundle:Product:_info.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Product/_info.html.twig");
    }
}
