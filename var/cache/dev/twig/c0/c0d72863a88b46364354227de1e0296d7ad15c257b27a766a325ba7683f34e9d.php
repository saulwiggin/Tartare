...
class __TwigTemplate_4de0a916ee2b9adfb8ea4a1b72e12e49836b6a5f12ac19aff8788ecd0fd24c71 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_default($__message__ = null, $__icon__ = null, $__type__ = null, $__header__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            echo " message\" ";
            echo call_user_func_array($this->env->getFunction('sylius_test_html_attribute')->getCallable(), ["flash-message", (isset($context["type"]) || array_key_exists("type", $context) ? $context["type"] : (function () { throw new RuntimeError('Variable "type" does not exist.', 2, $this->source); })())]);
            echo ">
        <i class=\"";
            // line 3
...
{% endmacro %}
", "SyliusUiBundle:Macro:messages.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Macro/messages.html.twig");
    }
}
