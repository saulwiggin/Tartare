...
class __TwigTemplate_dd1c9387bc2f29d7056cac4357013170f63ab518e1c2b53538e90781e568a983 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ui three column centered stackable grid\">
        ...
        echo "
                ";
        // line 20
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 20, $this->source); })()), "email", [], "any", false, false, false, 20), 'row', call_user_func_array($this->env->getFunction('sylius_test_form_attribute')->getCallable(), ["reset-email"]));
        echo "

                ";
        // line 22
        echo $this->extensions['Sylius\Bundle\UiBundle\Twig\TemplateEventExtension']->render("sylius.shop.request_password_reset_token.form", ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 22, $this->source); })())]);
        echo "
...
";
    ...
    {
        return array (  122 => 28,  117 => 26,  113 => 25,  109 => 24,  104 => 22,  99 => 20,  95 => 19,  89 => 16,  83 => 13,  79 => 12,  71 => 6,  61 => 5,  50 => 1,  48 => 3,  35 => 1,);
    }
...
{% endblock %}
", "SyliusShopBundle:Account:requestPasswordReset.html.twig", "/Users/drsilaswiggin/dev/e-commerce/Tartare/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Account/requestPasswordReset.html.twig");
    }
}
