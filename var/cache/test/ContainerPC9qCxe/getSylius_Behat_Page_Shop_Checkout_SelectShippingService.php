...
// Returns the private 'sylius.behat.page.shop.checkout.select_shipping' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/Checkout/SelectShippingPageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/Checkout/SelectShippingPage.php';

return $this->privates['sylius.behat.page.shop.checkout.select_shipping'] = new \Sylius\Behat\Page\Shop\Checkout\SelectShippingPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()));
