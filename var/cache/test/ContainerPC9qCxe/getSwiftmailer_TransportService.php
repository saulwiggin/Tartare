...
$this->services['swiftmailer.transport'] = $instance = new \Swift_Transport_SpoolTransport(($this->privates['swiftmailer.mailer.default.transport.eventdispatcher'] ?? ($this->privates['swiftmailer.mailer.default.transport.eventdispatcher'] = new \Swift_Events_SimpleEventDispatcher())), ($this->privates['swiftmailer.mailer.default.spool.file'] ?? ($this->privates['swiftmailer.mailer.default.spool.file'] = new \Swift_FileSpool(($this->targetDir.''.'/spool/default')))));
