...
// Returns the private 'sylius.behat.page.admin.promotion_coupon.generate' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/PromotionCoupon/GeneratePageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/PromotionCoupon/GeneratePage.php';

return $this->privates['sylius.behat.page.admin.promotion_coupon.generate'] = new \Sylius\Behat\Page\Admin\PromotionCoupon\GeneratePage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()));
