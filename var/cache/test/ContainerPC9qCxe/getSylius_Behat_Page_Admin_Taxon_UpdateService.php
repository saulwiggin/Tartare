...
// Returns the private 'sylius.behat.page.admin.taxon.update' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Taxon/UpdatePageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Behaviour/ChecksCodeImmutability.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Taxon/UpdatePage.php';

return $this->privates['sylius.behat.page.admin.taxon.update'] = new \Sylius\Behat\Page\Admin\Taxon\UpdatePage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), 'sylius_admin_taxon_update');
