...
// Returns the private 'sylius.behat.page.admin.administrator.update' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Administrator/UpdatePageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Administrator/UpdatePage.php';

return $this->privates['sylius.behat.page.admin.administrator.update'] = new \Sylius\Behat\Page\Admin\Administrator\UpdatePage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), 'sylius_admin_admin_user_update');
