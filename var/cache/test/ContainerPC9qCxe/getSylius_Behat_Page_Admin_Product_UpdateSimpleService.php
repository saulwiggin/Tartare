...
// Returns the private 'sylius.behat.page.admin.product.update_simple' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Product/UpdateSimpleProductPageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Behaviour/ChecksCodeImmutability.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Product/UpdateSimpleProductPage.php';

return $this->privates['sylius.behat.page.admin.product.update_simple'] = new \Sylius\Behat\Page\Admin\Product\UpdateSimpleProductPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), 'sylius_admin_product_update');
