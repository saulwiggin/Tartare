...
// Returns the private 'sylius.behat.page.shop.order.thank_you' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/Order/ThankYouPageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/Order/ThankYouPage.php';

return $this->privates['sylius.behat.page.shop.order.thank_you'] = new \Sylius\Behat\Page\Shop\Order\ThankYouPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()));
