...
// Returns the private 'sylius.behat.page.admin.promotion_coupon.update' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/PromotionCoupon/UpdatePageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Behaviour/ChecksCodeImmutability.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/PromotionCoupon/UpdatePage.php';

return $this->privates['sylius.behat.page.admin.promotion_coupon.update'] = new \Sylius\Behat\Page\Admin\PromotionCoupon\UpdatePage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), 'sylius_admin_promotion_coupon_update');
