...
return $this->privates['liip_imagine.filter.loader.watermark'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader(($this->privates['liip_imagine.gd'] ?? $this->load('getLiipImagine_GdService.php')), (\dirname(__DIR__, 4).'/src'));
