...
// Returns the private 'sylius.behat.page.admin.product_variant.generate' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/ProductVariant/GeneratePageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/ProductVariant/GeneratePage.php';

return $this->privates['sylius.behat.page.admin.product_variant.generate'] = new \Sylius\Behat\Page\Admin\ProductVariant\GeneratePage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), 'product_variant');
