...
// Returns the private 'sylius.behat.page.admin.tax_rate.create' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/TaxRate/CreatePageInterface.php';
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/TaxRate/CreatePage.php';

return $this->privates['sylius.behat.page.admin.tax_rate.create'] = new \Sylius\Behat\Page\Admin\TaxRate\CreatePage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), 'sylius_admin_tax_rate_create');
