...
// Returns the private 'sylius.behat.page.shop.account.request_password_reset' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/Account/RequestPasswordResetPageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/Account/RequestPasswordResetPage.php';

return $this->privates['sylius.behat.page.shop.account.request_password_reset'] = new \Sylius\Behat\Page\Shop\Account\RequestPasswordResetPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()));
