...
// Returns the private 'sylius.behat.page.admin.payment_method.create' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/PaymentMethod/CreatePageInterface.php';
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/PaymentMethod/CreatePage.php';

return $this->privates['sylius.behat.page.admin.payment_method.create'] = new \Sylius\Behat\Page\Admin\PaymentMethod\CreatePage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), 'sylius_admin_payment_method_create');
