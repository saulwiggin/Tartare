...
// Returns the private 'sylius.behat.page.admin.product.index' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Product/IndexPageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Product/IndexPage.php';
...
return $this->privates['sylius.behat.page.admin.product.index'] = new \Sylius\Behat\Page\Admin\Product\IndexPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), ($this->privates['sylius.behat.table_accessor'] ?? ($this->privates['sylius.behat.table_accessor'] = new \Sylius\Behat\Service\Accessor\TableAccessor())), 'sylius_admin_product_index', ($this->services['sylius.behat.checker.image_existence'] ?? $this->load('getSylius_Behat_Checker_ImageExistenceService.php')));
