...
// Returns the private 'sylius.behat.page.admin.product.create_configurable' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Product/CreateConfigurableProductPageInterface.php';
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Product/CreateConfigurableProductPage.php';

return $this->privates['sylius.behat.page.admin.product.create_configurable'] = new \Sylius\Behat\Page\Admin\Product\CreateConfigurableProductPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()), 'sylius_admin_product_create');
