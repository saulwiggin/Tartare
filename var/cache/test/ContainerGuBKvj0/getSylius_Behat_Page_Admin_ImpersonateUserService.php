...
// Returns the private 'sylius.behat.page.admin.impersonate_user' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Administrator/ImpersonateUserPageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Administrator/ImpersonateUserPage.php';

return $this->privates['sylius.behat.page.admin.impersonate_user'] = new \Sylius\Behat\Page\Admin\Administrator\ImpersonateUserPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()));
