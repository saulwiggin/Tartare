...
// Returns the private 'swiftmailer.mailer.default.spool.file' shared service.
...
return $this->privates['swiftmailer.mailer.default.spool.file'] = new \Swift_FileSpool(($this->targetDir.''.'/spool/default'));
