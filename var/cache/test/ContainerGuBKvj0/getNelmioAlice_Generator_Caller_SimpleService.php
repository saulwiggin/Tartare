...
return $this->privates['nelmio_alice.generator.caller.simple'] = new \Nelmio\Alice\Generator\Caller\SimpleCaller(($this->privates['nelmio_alice.generator.caller.registry'] ?? $this->load('getNelmioAlice_Generator_Caller_RegistryService.php')), ($this->privates['nelmio_alice.generator.resolver.value.registry'] ?? $this->load('getNelmioAlice_Generator_Resolver_Value_RegistryService.php')), ($this->privates['nelmio_alice.generator.named_arguments_resolver'] ?? ($this->privates['nelmio_alice.generator.named_arguments_resolver'] = new \Nelmio\Alice\Generator\NamedArgumentsResolver())));
