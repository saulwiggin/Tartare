...
// Returns the private 'sylius.behat.page.admin.shipment.show' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Shipment/ShowPageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Admin/Shipment/ShowPage.php';

return $this->privates['sylius.behat.page.admin.shipment.show'] = new \Sylius\Behat\Page\Admin\Shipment\ShowPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()));
