...
// Returns the private 'sylius_fixtures.listener.orm_purger' shared service.
...
return $this->privates['sylius_fixtures.listener.orm_purger'] = new \Sylius\Bundle\FixturesBundle\Listener\ORMPurgerListener(($this->services['doctrine'] ?? $this->getDoctrineService()));
