...
return $this->privates['nelmio_alice.generator.instantiator.registry'] = new \Nelmio\Alice\Generator\Instantiator\InstantiatorRegistry([0 => ($this->privates['nelmio_alice.generator.instantiator.chainable.no_caller_method_instantiator'] ?? $this->load('getNelmioAlice_Generator_Instantiator_Chainable_NoCallerMethodInstantiatorService.php')), 1 => ($this->privates['nelmio_alice.generator.instantiator.chainable.null_constructor_instantiator'] ?? ($this->privates['nelmio_alice.generator.instantiator.chainable.null_constructor_instantiator'] = new \Nelmio\Alice\Generator\Instantiator\Chainable\NullConstructorInstantiator())), 2 => ($this->privates['nelmio_alice.generator.instantiator.chainable.no_method_call_instantiator'] ?? ($this->privates['nelmio_alice.generator.instantiator.chainable.no_method_call_instantiator'] = new \Nelmio\Alice\Generator\Instantiator\Chainable\NoMethodCallInstantiator())), 3 => ($this->privates['nelmio_alice.generator.instantiator.chainable.static_factory_instantiator'] ?? $this->load('getNelmioAlice_Generator_Instantiator_Chainable_StaticFactoryInstantiatorService.php'))]);
