...
// Returns the private 'sylius.behat.page.shop.product_reviews.create' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/ProductReview/CreatePageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/ProductReview/CreatePage.php';

return $this->privates['sylius.behat.page.shop.product_reviews.create'] = new \Sylius\Behat\Page\Shop\ProductReview\CreatePage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()));
