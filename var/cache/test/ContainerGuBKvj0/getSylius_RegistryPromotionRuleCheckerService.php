...
$instance->register('customer_group', ($this->privates['sylius.promotion_rule_checker.customer_group'] ?? ($this->privates['sylius.promotion_rule_checker.customer_group'] = new \Sylius\Component\Core\Promotion\Checker\Rule\CustomerGroupRuleChecker())));
