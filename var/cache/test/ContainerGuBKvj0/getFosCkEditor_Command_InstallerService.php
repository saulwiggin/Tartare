...
$this->privates['fos_ck_editor.command.installer'] = $instance = new \FOS\CKEditorBundle\Command\CKEditorInstallerCommand(($this->privates['fos_ck_editor.installer'] ?? ($this->privates['fos_ck_editor.installer'] = new \FOS\CKEditorBundle\Installer\CKEditorInstaller())));
