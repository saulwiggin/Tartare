...
// Returns the private 'sylius.behat.page.shop.checkout.select_payment' shared service.
...
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/Checkout/SelectPaymentPageInterface.php';
include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Behat/Page/Shop/Checkout/SelectPaymentPage.php';

return $this->privates['sylius.behat.page.shop.checkout.select_payment'] = new \Sylius\Behat\Page\Shop\Checkout\SelectPaymentPage(($this->services['behat.mink.default_session'] ?? $this->load('getBehat_Mink_DefaultSessionService.php')), ($this->services['behat.mink.parameters'] ?? $this->load('getBehat_Mink_ParametersService.php')), ($this->services['router'] ?? $this->getRouterService()));
