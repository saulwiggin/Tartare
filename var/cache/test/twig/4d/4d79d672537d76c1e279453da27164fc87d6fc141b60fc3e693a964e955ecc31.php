...
class __TwigTemplate_8d0a8ee144e411c8d023f28fe6d49cdbcf8dfd154c092fe00293cb6a6dca4b5e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <ul>
        ";
            ...
            $context['_seq'] = twig_ensure_traversable(twig_array_filter((isset($context["taxons"]) || array_key_exists("taxons", $context) ? $context["taxons"] : (function () { throw new RuntimeError('Variable "taxons" does not exist.', 9, $this->source); })()), function ($__taxon__) use ($context, $macros) { $context["taxon"] = $__taxon__; return  !(null === twig_get_attribute($this->env, $this->source, $context["taxon"], "id", [], "any", false, false, false, 9)); }));
...
", "@SyliusAdmin/Taxon/_treeWithButtons.html.twig", "/Users/drsilaswiggin/dev/e-commerce/demo/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Taxon/_treeWithButtons.html.twig");
    }
}
