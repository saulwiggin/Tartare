...
class __TwigTemplate_44acf04a37d08f427afb7919e2a76b32e4d49b39a7afaf1f52c0c59c4936e207 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block icon %}
    ...
    {% if icon %}<i class=\"icon {{ icon }}\"></i> {% endif %}
{% endblock %}
", "@SyliusUi/Menu/top.html.twig", "/Users/drsilaswiggin/dev/e-commerce/demo/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Menu/top.html.twig");
    }
}
