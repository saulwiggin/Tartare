...
class __TwigTemplate_818dde9a6c2b30e4862206e977111fa8629139266f924ed5915346a0758416e8 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ui attached segment\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["locale"]) {
            ...
            // line 17
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_array_filter(twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 17, $this->source); })()), "attributes", [], "any", false, false, false, 17), function ($__attributeValue__) use ($context, $macros) { $context["attributeValue"] = $__attributeValue__; return (twig_get_attribute($this->env, $this->source, $context["attributeValue"], "localeCode", [], "any", false, false, false, 17) == $context["locale"]); }));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["attributeValue"]) {
                ...
                echo "</strong>
                            ...
                            <td>
                                ";
                // line 23
                $this->loadTemplate([0 => (("@SyliusAdmin/Product/Show/Types/" . twig_get_attribute($this->env, $this->source, $context["attributeValue"], "type", [], "any", false, false, false, 23)) . ".html.twig"), 1 => "@SyliusAdmin/Product/Show/Types/default.html.twig"], "@SyliusAdmin/Product/Show/_attributes.html.twig", 23)->display(twig_array_merge($context, ["attribute" => $context["attributeValue"], "locale" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["configuration"]) || array_key_exists("configuration", $context) ? $context["configuration"] : (function () { throw new RuntimeError('Variable "configuration" does not exist.', 23, $this->source); })()), "request", [], "any", false, false, false, 23), "locale", [], "any", false, false, false, 23), "fallbackLocale" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["configuration"]) || array_key_exists("configuration", $context) ? $context["configuration"] : (function () { throw new RuntimeError('Variable "configuration" does not exist.', 23, $this->source); })()), "request", [], "any", false, false, false, 23), "defaultLocale", [], "any", false, false, false, 23)]));
                // line 24
                echo "                            </td>
                        </tr>
                    ";
...
";
    ...
    {
        return array (  206 => 31,  189 => 27,  173 => 24,  171 => 23,  165 => 20,  161 => 18,  144 => 17,  131 => 14,  114 => 13,  111 => 12,  97 => 11,  94 => 10,  92 => 9,  75 => 8,  72 => 7,  54 => 6,  52 => 5,  46 => 2,  43 => 1,);
    }
...
", "@SyliusAdmin/Product/Show/_attributes.html.twig", "/Users/drsilaswiggin/dev/e-commerce/demo/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Product/Show/_attributes.html.twig");
    }
}
